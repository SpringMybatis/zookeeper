...
import com.cetc32.zookeeper.client.MyZookeeper;
import com.cetc32.zookeeper.service.ZKOperateService;
...
public class ZookeeperTest {
    ...
    public static void main(String[] args) {
        ...
        //ZKOperate操作API
        ZKOperateService zkWatchAPI = new ZKOperateService();

        // 连接zk服务器
        MyZookeeper zooKeeper = new MyZookeeper();
        zooKeeper.connect("192.168.1.209:2181", 2000);
